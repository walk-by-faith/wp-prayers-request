		...
		success: function(data) {
			//if(data=="Prayed" || data=="Orado"|| data=="Prier"){
				...
				setTimeout(function(){					
					...
					if(data=="Prayed"){jQuery('#do_pray_'+pray_id).val('Pray');}
					if(data=="Orado"){jQuery('#do_pray_'+pray_id).val('Orar');}
					if(data=="Prié"){jQuery('#do_pray_'+pray_id).val('Prier');}
					if(data=="Gebeden"){jQuery('#do_pray_'+pray_id).val('Bidden');}
					if(data=="Rukoiltu"){jQuery('#do_pray_'+pray_id).val('Rukoile');}
					if(data=="Elmondva"){jQuery('#do_pray_'+pray_id).val('Ima');}
					if(data=="Zmówiono"){jQuery('#do_pray_'+pray_id).val('Pomódl się');}
					if(data=="祈祷"){jQuery('#do_pray_'+pray_id).val('祈祷');}
					if(data=="祈禱"){jQuery('#do_pray_'+pray_id).val('祈禱');}
					// else {
					//	jQuery('#do_pray_'+pray_id).val('Orar');
					//}
				},time_interval);
